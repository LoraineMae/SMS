...
export const QueueTicket = ({ patient, onBack }) => {
  return (
    <div style={{ minHeight:'100vh', background:'#1a1d23', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'2rem', fontFamily:'Poppins, sans-serif' }}>

      {/* Header */}
      <div style={{ textAlign:'center', marginBottom:'2rem' }}>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:10, marginBottom:8 }}>
          <Activity color="#3b82f6" size={24}/>
          <h1 style={{ color:'white', fontWeight:900, fontSize:'1.4rem', fontStyle:'italic', letterSpacing:'-1px', margin:0 }}>
      ...
      {/* Ticket Card */}
      <div style={{ width:'100%', maxWidth:'400px', background:'linear-gradient(145deg,#2c3038,#353a43)', borderRadius:'2rem', border:'1px solid rgba(255,255,255,0.08)', boxShadow:'0 20px 60px rgba(0,0,0,0.5)', overflow:'hidden' }}>
        ...
        <div style={{ padding:'2rem' }}>
          ...
          <div style={{ textAlign:'center', marginBottom:'1.5rem' }}>
            ...
            <h2 style={{ color:'white', fontWeight:900, fontSize:'1.6rem', margin:0 }}>{patient.fullname}</h2>
          </div>

          {/* Queue number */}
          <div style={{ textAlign:'center', background:'rgba(59,130,246,0.08)', border:'2px dashed rgba(59,130,246,0.25)', borderRadius:'1rem', padding:'1.5rem', marginBottom:'1.5rem' }}>
            ...
            <div style={{ fontSize:'4rem', fontWeight:900, color:'#3b82f6', lineHeight:1 }}>
          ...
          {/* Monitor tip */}
          <div style={{ background:'rgba(59,130,246,0.08)', border:'1px solid rgba(59,130,246,0.15)', borderRadius:'0.75rem', padding:'1rem', marginBottom:'1.5rem' }}>
            <p style={{ color:'#60a5fa', fontSize:'12px', fontWeight:700, margin:'0 0 4px', textTransform:'uppercase', letterSpacing:'0.05em' }}>📺 Queue Monitor</p>
            <p style={{ color:'#1e3a5f', fontSize:'11px', margin:0, lineHeight:1.5, color:'#93c5fd' }}>
              Watch the waiting room display screen to track your queue position once your priority is assigned.
            </p>
          </div>

          <button onClick={onBack} style={{ width:'100%', background:'transparent', border:'1px solid rgba(255,255,255,0.08)', color:'#6b7280', padding:'0.9rem', borderRadius:'0.75rem', fontWeight:700, fontSize:'12px', textTransform:'uppercase', letterSpacing:'0.1em', cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center', gap:8 }}>
            <ArrowLeft size={14}/> Back to Home
          </button>
        </div>

        {/* Bottom note */}
        <div style={{ borderTop:'1px dashed rgba(255,255,255,0.06)', padding:'1rem', textAlign:'center' }}>
          <p style={{ color:'#374151', fontSize:'11px', margin:0 }}>Please stay in the waiting area and listen for your name to be called.</p>
        </div>
      </div>
    </div>
  );
