...
const DARK = {
  page:          '#111614',
  header:        { background:'linear-gradient(135deg,#191e1b,#0e1310)', borderBottom:'2px solid rgba(34,197,94,0.2)' },
  titleColor:    '#e4efe8',
  subtitleColor: 'rgba(228,239,232,0.45)',
  clockColor:    '#e4efe8',
  dateColor:     'rgba(228,239,232,0.45)',
  nowBanner:     { background:'rgba(34,197,94,0.08)', borderBottom:'1px solid rgba(34,197,94,0.2)' },
  nowNameColor:  '#e4efe8',
  nowTicketColor:'rgba(228,239,232,0.45)',
  colHeaderColor:'rgba(228,239,232,0.3)',
  rowBg:         'rgba(255,255,255,0.025)',
  rowBorder:     '1px solid rgba(34,197,94,0.08)',
  numColor:      'rgba(228,239,232,0.2)',
  ticketColor:   '#e4efe8',
  nameColor:     '#e4efe8',
  metaColor:     'rgba(228,239,232,0.4)',
  emptyColor:    'rgba(228,239,232,0.2)',
  footer:        { borderTop:'1px solid rgba(34,197,94,0.08)', background:'transparent' },
  footerTextColor:'rgba(228,239,232,0.3)',
  pendingBg:     'rgba(245,158,11,0.04)',
  pendingBorder: '1px dashed rgba(245,158,11,0.12)',
  sectionDivider:'1px dashed rgba(34,197,94,0.1)',
  toggleBg:      'rgba(255,255,255,0.06)',
  toggleBorder:  'rgba(255,255,255,0.1)',
  toggleColor:   'rgba(228,239,232,0.5)',
  loadColor:     'rgba(228,239,232,0.3)',
};
